...
function abos_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_abo_offres'] = [
		...
		'titre' => "titre AS titre, '' AS lang",
		 #'date' => "",
		'champs_editables'  => ['titre', 'slug', 'descriptif', 'texte', 'duree', 'prix_ht', 'prix_ht_renouvellement','taxe','mode_renouvellement','immateriel','poids','largeur','longueur','hauteur'],
		'champs_versionnes' => ['titre', 'slug', 'descriptif', 'texte', 'duree', 'prix_ht', 'prix_ht_renouvellement','taxe','mode_renouvellement','immateriel','poids','largeur','longueur','hauteur'],
